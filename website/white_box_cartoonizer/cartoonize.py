...
from website.white_box_cartoonizer import guided_filter, network
try:
...
if __name__ == '__main__':
    ...
    wbc = WB_Cartoonize(os.path.abspath('website/white_box_cartoonizer/saved_models'), gpu)
    img = cv2.imread('website/white_box_cartoonizer/test.jpg')
